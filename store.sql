...
CREATE TABLE `store` (
  ...
  `store_zip_code` varchar(10) NOT NULL DEFAULT '',
...
INSERT INTO `store` VALUES (1,'Likhit','411043'),(2,'Mahavir Provision Store','411043');
...
-- Dump completed on 2016-09-22  5:13:54
